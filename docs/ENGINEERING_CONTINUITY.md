...
## Ecosystem position
 Human-in-the-loop AI workflow orchestration

## Current mission
Human-in-the-loop layer: orchestrates AI workflows with approval gates, state transitions and auditable human intervention.
